...
import kr.co.metasoft.groupware.api.common.entity.id.RoleUserEntityId;
...
public class ApiCommonRoleUserController {
	...
	/*
	 * @PutMapping (path = "/updateRoleUser") public PageResponse<RoleUserEntity>
	 * updateRoleUser (
	 * 
	 * @RequestBody List<RoleUserDto> roleUserDtoList) {
	 * 
	 * return roleUserService.getRoleUserList(roleUserParamDto, null); }
	 */
