        ...
        "methods": {
            "setBanIPDeatil": async function (queryId) {
                ...
                return new Promise(function (resolve, reject) {
                    Promise.resolve()
                        .then(function () {
                            return  metaojt.api.common.banIP.getBanIP(queryId);
                        })
            ...
            "registerNewBanIP" : async function () {
                ...
                {
                    await metaojt.alert("IP 주소를 반드시 입력하세요.");
                    return;
                }
                ...
                if (await metaojt.confirm("저장 하시겠습니까?")) {
                    ...
                    new Promise(function (resolve, reject) {
                        Promise.resolve()
                            .then(function () {
                                return metaojt.api.common.banIP.createBanIP(params);
                            })
                            .then(function () { resolve(); });
                    });
            ...
            "updateBanIP" : async function () {
                ...
                {
                    await metaojt.alert("IPv4 형식에 맞지 않습니다.");
                    return;
                }
                ...
                {
                    await metaojt.alert("IPv6 형식에 맞지 않습니다.");
                    return;
                }
                ...
                if (await metaojt.confirm("수정 하시겠습니까?")) {
                    ...
                    new Promise(function (resolve, reject) {
                        Promise.resolve()
                            .then(function () {
                                 return metaojt.api.common.banIP.modifyBanIP( params.id, params);
                            })
                            .then(function () { resolve();  });
                    });
